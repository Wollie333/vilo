...
import TenantHealthRing from './TenantHealthRing'
import { StatusIcon } from './TenantDetailSidebar'
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="lg:hidden">
                <TenantHealthRing percentage={healthPercentage} size={40} strokeWidth={4} />
              </div>
            </div>
