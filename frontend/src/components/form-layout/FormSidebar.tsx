...
export default function FormSidebar({
  ...
  const getMessage = () => {
    if (completenessPercentage >= 80) return 'Looking great!'
    if (completenessPercentage >= 50) return 'Good progress!'
    return progressLabel || 'Complete the form'
  }
      ...
      <div className="sticky top-24 space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <div className="flex flex-col items-center">
            <FormProgress percentage={completenessPercentage} />
