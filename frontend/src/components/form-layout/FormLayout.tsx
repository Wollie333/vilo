...
import { Loader2, ChevronUp, Eye, Check, ChevronDown, ArrowLeft } from 'lucide-react'
import FormProgress from './FormProgress'
import { StatusIcon } from './FormSidebar'
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="lg:hidden">
                <FormProgress percentage={completenessPercentage} size={40} strokeWidth={4} />
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Header extra content (toggles, links, etc) */}
              {headerExtra}
